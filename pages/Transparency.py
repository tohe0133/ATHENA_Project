...
"*Accuracy*: Accuracy measures the overall correctness of the model's predictions. As the dataset at hand is balanced and large accuracy is a good metric to evaluate the models performance.")
